...
Use when the user says: intake this policy, extract and check this policy, declarations check.
...
```
python ~/.claude/skills/policy-declarations-check/scripts/extract_declarations.py --input <policy.txt>
```
